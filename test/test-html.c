...
bool test_html(void) {
    ...
    if( html ) {
        ...
        CS_FAIL_ON_NULL( CS_htmlSetContents( head, headContents, false ), "Contents should be set.", "Nope." );
        struct CS_HtmlNode *body = CS_htmlAddContainerAfter( html, "body" );
        CS_FAIL_ON_NULL( body, "Body added.", "Nope." );
        CS_FAIL_ON_NULL( CS_htmlSetContents( body, bodyContents, false ), "Setting contents of the body.", "Nope." );
    ...
    if( html ) {
        struct CS_HtmlNode *body = CS_htmlAddContainerAfter( html, "body" );
        CS_htmlSetContents( body, bodyContents, false );
        struct CS_HtmlNode *head = CS_htmlAddContainerBefore( html, "head" );
        CS_htmlSetContents( head, headContents, false );
        struct CS_HtmlNode *div2 = CS_htmlAddContainerAfter( body, "div" );
        CS_FAIL_ON_NULL( div2, "Creating div2 in body.", "Nope." );
        CS_FAIL_ON_NULL( CS_htmlSetContents( div2, div2Contents, false ), "Adding contents to div2.", "Nope." );
